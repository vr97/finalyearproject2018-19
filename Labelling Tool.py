...
class LabelTweet:
    def __init__(self):
        ...
        self.result = 0
        self.file = "C:\\Users\\Vivek Rao\\Desktop\\TO ANNOTATE\\Rahul To Annotate 2000.xls"
        self.data = xlrd.open_workbook(self.file)
        self.row_number = 1
        self.labelling_column = 3
        self.text_column = 2
        self.window = None
        # saves only xls version
        self.output_file = "C:\\Users\\Vivek Rao\\Desktop\\TO ANNOTATE\\Rahul Annotated 17_03_2019 2000.xls"
